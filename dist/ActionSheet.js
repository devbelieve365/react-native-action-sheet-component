...
var BackHandler=_reactNative.BackHandler;
...
separator=_react2.default.createElement(_Separator2.default,{__source:{fileName:_jsxFileName,lineNumber:320}});
}
...
return(
_react2.default.createElement(_reactNative.View,{style:{flex:1},__source:{fileName:_jsxFileName,lineNumber:336}},
item,
separator));
...
if(
[ACTION_SHEET_OPENED,ACTION_SHEET_OPENING].includes(actionSheetState))
{
overlayShow=true;
pointerEvents="auto";
}
...
var itemsStyle=isTop?{paddingTop:30}:null;
...
return(
_react2.default.createElement(_reactNative.View,{style:[styles.container],__source:{fileName:_jsxFileName,lineNumber:385}},
...
useNativeDirver:true,__source:{fileName:_jsxFileName,lineNumber:386}}),
...
width,
{
transform:[{translateY:transformOffsetY}]}],__source:{fileName:_jsxFileName,lineNumber:394}},



_react2.default.createElement(_reactNative.ScrollView,{
style:[styles.scrollView,scrollViewStyle],
scrollEnabled:scrollEnabled,__source:{fileName:_jsxFileName,lineNumber:404}},

_react2.default.createElement(_reactNative.View,{onLayout:this.getActionSheetHeight,style:itemsStyle,__source:{fileName:_jsxFileName,lineNumber:408}},
this.renderItems())))));
